  ...
  const ExperienceItem = ({ title, period, details, index }) => {
    ...
    return (
      <div className="text-center">
        <div className={`flex items-center justify-center w-16 h-16 mx-auto bg-white border-2 border-gray-200 rounded-full shadow ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
    ...
    <section id="experience" className={`relative ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'} py-10 sm:py-16 lg:py-24`}>
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className={`text-4xl ${isDarkMode ? 'text-white' : 'text-gray-800'} font-extrabold mx-auto md:text-6xl lg:text-5xl`}>Work Experience</h2>
        ...
        <div className="relative mt-12 lg:mt-20">
          <div className="absolute inset-x-0 hidden xl:px-44 top-2 md:block md:px-20 lg:px-28">
            <img alt="" loading="lazy" width="1000" height="500" decoding="async" data-nimg="1" className="w-full" style={{ color: 'transparent' }} src="https://cdn.rareblocks.xyz/collection/celebration/images/steps/2/curved-dotted-line.svg" />
          </div>
