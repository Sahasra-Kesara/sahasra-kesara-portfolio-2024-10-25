...
const SlideInCard = () => {
  ...
  return (
    <div className={`fixed top-16 right-0 flex items-center justify-center animate-bounce py-4 z-50 mx-4 ${animate}`}>
          ...
          <div className="w-full md:w-7/12 lg:w-2/3 flex items-center px-2">
            ...
            <div className="mb-6 md:mb-0">
              ...
              <p className={`text-sm font-medium ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                Go to my GitHub account and see my Open Source Projects
              </p>
            </div>
          </div>
          <div className="w-full md:w-5/12 lg:w-1/3 flex items-center justify-between">
            <a
              href="https://github.com/Sahasra-Kesara/"
